...
public static class JsonConfiguration
{
    ...
    /// </summary>
    public static readonly JsonSerializerOptions Default = new(Base)
    {
        WriteIndented = false
    };
    ...
    /// </summary>
    public static readonly JsonSerializerOptions ForLogging = new(Base)
    {
        WriteIndented = true
    };
    ...
    /// </summary>
    public static readonly JsonSerializerOptions ForApi = new(Base)
    {
        WriteIndented = true
    };
